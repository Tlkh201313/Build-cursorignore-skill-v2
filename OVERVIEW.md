...
2. Detects tech stack from signal files (24 stacks: JS/TS, Next.js, Nuxt, Python, Django, Flask, Java, Kotlin, Rust, Go, PHP, Ruby, Rails, iOS/Swift, Android, Bun, Deno, Flutter, Elixir, Scala, and more)
